...
?>
    ...
    <section>
        <div class="container">
            ...
            $productsxtrem1 = array_intersect_key($productsxtrem, array_flip(array_rand($productsxtrem, 3))); 

            $index = $index + 1;
            foreach ($productsxtrem1 as $k => $v)
                {
                $titreCard = $k;
                $imagePresentation = $v[0];
                $description = $v[1];
    ...
    <section>
        <div class="container">
            ...
            <?php
            //Trouvé sur le net car chaud :
            $productsxtrem2 = array_intersect_key($productsxtrem, array_flip(array_rand($productsxtrem, 3))); 

            $index = $index + 1;
            foreach ($productsxtrem2 as $k => $v)
                {
                $titreCard = $k;
                $imagePresentation = $v[0];
                $description = $v[1];
