...
<head>
    <title><?php echo $titrePage1 ?></title>
    <meta charset="utf-8">
...
?>
    ...
    <section>
        <div class="container">
            ...
            $products1dream = array_intersect_key($productsdream, array_flip(array_rand($productsdream, 3))); 

            $index = $index + 1;
            foreach ($products1dream as $k => $v)
                {
                $titreCard = $k;
                $imagePresentation = $v[0];
                $description = $v[1];
    ...
    <section>
        <div class="container">
            ...
            <?php
            //Trouvé sur le net car chaud :
            $products2dream = array_intersect_key($productsdream, array_flip(array_rand($productsdream, 3))); 

            $index = $index + 1;
            foreach ($products2dream as $k => $v)
                {
                $titreCard = $k;
                $imagePresentation = $v[0];
                $description = $v[1];
