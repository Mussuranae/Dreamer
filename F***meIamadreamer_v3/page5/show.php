...
<head>
    <title><?php echo $titrePage5 ?></title>
    <meta charset="utf-8">
...
?>
    ...
    <section>
        <div class="container">
            ...
            $products1show = array_intersect_key($productsshow, array_flip(array_rand($productsshow, 3))); 

            $index = $index + 1;
            foreach ($products1show as $k => $v)
                {
                $titreCard = $k;
                $imagePresentation = $v[0];
                $description = $v[1];
    ...
    <section>
        <div class="container">
            ...
            <?php
            //Trouvé sur le net car chaud :
            $products2show = array_intersect_key($productsshow, array_flip(array_rand($productsshow, 3))); 

            $index = $index + 1;
            foreach ($products2show as $k => $v)
                {
                $titreCard = $k;
                $imagePresentation = $v[0];
                $description = $v[1];
