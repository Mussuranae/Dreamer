...
<head>
    <title><?php echo $titrePage4 ?></title>
    <meta charset="utf-8">
...
?>
    ...
    <section>
        <div class="container">
            ...
            <?php
            $index = 0;
            foreach ($productsbedding as $k => $v)
                {
                $titreCard = $k;
    ...
    <section>
        <div class="container">
            ...
            $products1bedding = array_intersect_key($productsbedding, array_flip(array_rand($productsbedding, 3))); 

            $index = $index + 1;
            foreach ($products1bedding as $k => $v)
                {
                $titreCard = $k;
                $imagePresentation = $v[0];
                $description = $v[1];
    ...
    <section>
        <div class="container">
            ...
            <?php
            //Trouvé sur le net car chaud :
            $products2bedding = array_intersect_key($productsbedding, array_flip(array_rand($productsbedding, 3))); 

            $index = $index + 1;
            foreach ($products2bedding as $k => $v)
                {
                $titreCard = $k;
                $imagePresentation = $v[0];
                $description = $v[1];
